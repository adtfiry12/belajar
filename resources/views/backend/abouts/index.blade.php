            ...
            <div class="bg-white border-2 border-slate-950 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-8">
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="flex md:flex-col gap-2">
                        <button class="p-3 border-2 border-slate-950 bg-yellow-400 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-yellow-500 transition-all active:shadow-none active:translate-x-1 active:translate-y-1">
                        ...
                        <button class="p-3 border-2 border-slate-950 bg-red-600 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-red-700 transition-all active:shadow-none active:translate-x-1 active:translate-y-1">
